...
#
#
# Number of players needed to capture a CP
# Default is 2
C['AAS_MINNRTOTAKECONTROL'] = 2
#
#
# Number of players needed to neutralize a CP
# Default is 5
C['AAS_MINNRTONEUTRAL'] = 5
#
#
...
C['INSURGENCY_CIV_CARS'] = [
    'civ_bik_dirtbike', 'civ_bik_atv', 'civ_bik_hondacb500', 'civ_jep_forklift', 'civ_jep_support', 'civ_jep_car_white',
    'civ_jep_car_blue', 'civ_jep_car_black', 'civ_jep_car', 'civ_trk_dumpster', 'civ_trk_semi', 'civ_jep_zastava900ak'
]
#
#
...
C['KIT_LIMIT_8'] = {
    'sniper': 0, 'aa': 0, 'at': 0, 'engineer': 0, 'marksman': 1, 'assault': 1, 'riflemanat': 1,
    'riflemanap': 1, 'mg': 1, 'spotter': 1
}
C['KIT_LIMIT_16'] = {
    'sniper': 1, 'aa': 1, 'at': 1, 'engineer': 1, 'marksman': 2, 'assault': 2, 'riflemanat': 2,
    'riflemanap': 2, 'mg': 2, 'spotter': 1
}
C['KIT_LIMIT_24'] = {
    'sniper': 1, 'aa': 1, 'at': 1, 'engineer': 1, 'marksman': 3, 'assault': 4, 'riflemanat': 4,
    'riflemanap': 3, 'mg': 3, 'spotter': 1
}
C['KIT_LIMIT_32'] = {
    'sniper': 2, 'aa': 2, 'at': 1, 'engineer': 2, 'marksman': 3, 'assault': 5, 'riflemanat': 5,
    'riflemanap': 3, 'mg': 3, 'spotter': 2
}
C['KIT_LIMIT_44'] = {
    'sniper': 2, 'aa': 2, 'at': 1, 'engineer': 2, 'marksman': 4, 'assault': 8, 'riflemanat': 8,
...
C['KIT_SUPPLY_OBJECTS'] = {
    'us': {
        'pr_supply_crate_us': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_us': CONSTANTS.DISTANCE_PICKUP,
    ...
    'cf': {
        'pr_supply_crate_cf': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_cf': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_cf': CONSTANTS.DISTANCE_PICKUP
    },
    'gb': {
        'pr_supply_crate_gb': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_gb': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_gb': CONSTANTS.DISTANCE_PICKUP
    },
    'ger': {
        'pr_supply_crate_ger': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ger': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_ger': CONSTANTS.DISTANCE_PICKUP
    },
    'ch': {
        'pr_supply_crate_ch': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ch': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_ch': CONSTANTS.DISTANCE_PICKUP
    },
    'mec': {
        'ammocache': CONSTANTS.DISTANCE_PICKUP, 'pr_supply_crate_mec': CONSTANTS.DISTANCE_PICKUP,
        'light_supply_crate_mec': CONSTANTS.DISTANCE_PICKUP, 'fixed_supply_crate_mec': CONSTANTS.DISTANCE_PICKUP
    },
    'pl': {
        'pr_supply_crate_pl': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_pl': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_pl': CONSTANTS.DISTANCE_PICKUP
    },
    'ru': {
        'pr_supply_crate_ru': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ru': CONSTANTS.DISTANCE_PICKUP,
    ...
    'idf': {
        'pr_supply_crate_idf': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_idf': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_idf': CONSTANTS.DISTANCE_PICKUP
    },
    'arf': {
        'ammocache': CONSTANTS.DISTANCE_PICKUP, 'pr_supply_crate_tal': CONSTANTS.DISTANCE_PICKUP,
        'light_supply_crate_tal': CONSTANTS.DISTANCE_PICKUP, 'fixed_supply_crate_tal': CONSTANTS.DISTANCE_PICKUP
    },
    'chinsurgent': {
        'ammocache': CONSTANTS.DISTANCE_PICKUP, 'pr_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP,
    ...
    'vnnva': {
        'ammocache': CONSTANTS.DISTANCE_PICKUP, 'pr_supply_crate_vnnva': CONSTANTS.DISTANCE_PICKUP,
        'light_supply_crate_vnnva': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_vnnva': CONSTANTS.DISTANCE_PICKUP
    },
    'arg82': {
        'pr_supply_crate_arg': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_arg': CONSTANTS.DISTANCE_PICKUP,
    ...
    'nl': {
        'pr_supply_crate_nl': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_nl': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_nl': CONSTANTS.DISTANCE_PICKUP
    },
    'ww2ger': {
        'pr_supply_crate_ww2ger': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ww2ger': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_ww2ger': CONSTANTS.DISTANCE_PICKUP
    },
    'ww2usa': {
        'pr_supply_crate_ww2usa': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ww2usa': CONSTANTS.DISTANCE_PICKUP,
    ...
    'ww2rus': {
        'pr_supply_crate_ww2rus': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ww2rus': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_ww2rus': CONSTANTS.DISTANCE_PICKUP
    },
    'ww2rusearly': {
        'pr_supply_crate_ww2rus': CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ww2rus': CONSTANTS.DISTANCE_PICKUP,
        'fixed_supply_crate_ww2rus': CONSTANTS.DISTANCE_PICKUP
...
C['KIT_SUPPLY_OBJECTS_VEHICLES'] = {
    'us': {
        'us_apc_lav25': CONSTANTS.DISTANCE_PICKUP, 'us_ifv_m2a2': CONSTANTS.DISTANCE_PICKUP,
        'us_apc_aavp7a1': CONSTANTS.DISTANCE_PICKUP
    },
    'usa': {
        'us_apc_stryker': CONSTANTS.DISTANCE_PICKUP, 'us_apc_stryker_mk19': CONSTANTS.DISTANCE_PICKUP,
    ...
    'ger': {
        'ger_apc_fuchs': CONSTANTS.DISTANCE_PICKUP, 'ger_apc_puma': CONSTANTS.DISTANCE_PICKUP,
        'ger_ifv_puma': CONSTANTS.DISTANCE_PICKUP
    },
    'ch': {
        'ch_apc_wz551': CONSTANTS.DISTANCE_PICKUP,
        'ch_apc_wz551a': CONSTANTS.DISTANCE_PICKUP,
        'ch_ifv_wz551b': CONSTANTS.DISTANCE_PICKUP,
        'ch_ifv_type86': CONSTANTS.DISTANCE_PICKUP,
        'ch_ifv_zbl08': CONSTANTS.DISTANCE_PICKUP,
        'ch_apc_zbl08': CONSTANTS.DISTANCE_PICKUP
    },
    'mec': {
        'mec_apc_boragh': CONSTANTS.DISTANCE_PICKUP, 'mec_apc_btr60': CONSTANTS.DISTANCE_PICKUP,
    ...
    'pl': {
        'pl_apc_rosomak': CONSTANTS.DISTANCE_PICKUP,
        'pl_ifv_bwp1': CONSTANTS.DISTANCE_PICKUP
    },
    'ru': {
        'ru_apc_btr60': CONSTANTS.DISTANCE_PICKUP, 'ru_apc_btr80': CONSTANTS.DISTANCE_PICKUP,
        ...
        'ru_ifv_bmp2m': CONSTANTS.DISTANCE_PICKUP, 'ru_ifv_bmp1': CONSTANTS.DISTANCE_PICKUP
    },
    'ru90': {
        'ru_apc_btr60': CONSTANTS.DISTANCE_PICKUP, 'ru_apc_btr80': CONSTANTS.DISTANCE_PICKUP,
        'ru_apc_btr80_alt': CONSTANTS.DISTANCE_PICKUP, 'ru_apc_btr80a': CONSTANTS.DISTANCE_PICKUP,
    ...
    'idf': {
        'idf_apc_m113': CONSTANTS.DISTANCE_PICKUP, 'idf_apc_m113_logistics': CONSTANTS.DISTANCE_PICKUP,
        'idf_apc_namer': CONSTANTS.DISTANCE_PICKUP
    },
    'arf': {},
    'chinsurgent': {'mil_ifv_bmp1': CONSTANTS.DISTANCE_PICKUP},
    'chinsurgent90': {'mil_ifv_bmp1': CONSTANTS.DISTANCE_PICKUP},
    'chechen90': {'mil_ifv_bmp1': CONSTANTS.DISTANCE_PICKUP},
    'hamas': {},
    ...
    'ww2ger': {'ger_apc_251c': CONSTANTS.DISTANCE_PICKUP, 'ger_apc_251c_alt': CONSTANTS.DISTANCE_PICKUP, 'ger_apc_251c_1941': CONSTANTS.DISTANCE_PICKUP},
    'ww2ger41': {'ger_apc_251c': CONSTANTS.DISTANCE_PICKUP, 'ger_apc_251c_alt': CONSTANTS.DISTANCE_PICKUP, 'ger_apc_251c_1941': CONSTANTS.DISTANCE_PICKUP},
    'ww2usa': {'us_apc_m3': CONSTANTS.DISTANCE_PICKUP},
    'ww2rus': {'ru_apc_m3': CONSTANTS.DISTANCE_PICKUP, 'ru_apc_m3_alt': CONSTANTS.DISTANCE_PICKUP, 'ru_ifv_ba6': CONSTANTS.DISTANCE_PICKUP, 'ru_ifv_ba64': CONSTANTS.DISTANCE_PICKUP},
    'ww2rusearly': {'ru_apc_m3': CONSTANTS.DISTANCE_PICKUP, 'ru_apc_m3_alt': CONSTANTS.DISTANCE_PICKUP, 'ru_ifv_ba6': CONSTANTS.DISTANCE_PICKUP, 'ru_ifv_ba64': CONSTANTS.DISTANCE_PICKUP},
}
#
#
...
C['KIT_SUPPLY_OBJECTS_VEHICLES_SIDEDOORS'] = [
    'ru_apc_btr60', 'ru_apc_btr80', 'ru_apc_btr80_alt', 'ru_apc_btr80a', 'mec_apc_btr60', 'mec_apc_btr80'
]
#
#
# Kit supply objects that don't check for the object team ownership
# Default is DEPOT_KIT_DISTANCE or DEPOT_KIT_DISTANCE_WW2
C['KIT_SUPPLY_OBJECTS_OPEN'] = {
    'us': {'vehicle_depot_us': CONSTANTS.DEPOT_KIT_DISTANCE},
    'usa': {'vehicle_depot_us': CONSTANTS.DEPOT_KIT_DISTANCE},
    'cf': {'vehicle_depot_cf': CONSTANTS.DEPOT_KIT_DISTANCE},
    'gb': {'vehicle_depot_gb': CONSTANTS.DEPOT_KIT_DISTANCE},
    ...
    'idf': {'vehicle_depot_idf': CONSTANTS.DEPOT_KIT_DISTANCE},
    'arf': {'vehicle_depot_tal': CONSTANTS.DEPOT_KIT_DISTANCE},
    'chinsurgent': {'vehicle_depot_mil': CONSTANTS.DEPOT_KIT_DISTANCE},
    'chinsurgent90': {'vehicle_depot_mil': CONSTANTS.DEPOT_KIT_DISTANCE},
    'chechen90': {'vehicle_depot_mil': CONSTANTS.DEPOT_KIT_DISTANCE},
    'hamas': {'vehicle_depot_tal': CONSTANTS.DEPOT_KIT_DISTANCE},
    'taliban': {'vehicle_depot_tal': CONSTANTS.DEPOT_KIT_DISTANCE},
    'meinsurgent': {},
    'vnusa': {'vehicle_depot_us': CONSTANTS.DEPOT_KIT_DISTANCE},
    'vnusmc': {'vehicle_depot_us': CONSTANTS.DEPOT_KIT_DISTANCE},
    'vnnva': {'vehicle_depot_vnnva': CONSTANTS.DEPOT_KIT_DISTANCE},
    'gb82': {'vehicle_depot_gb': CONSTANTS.DEPOT_KIT_DISTANCE},
    'arg82': {'vehicle_depot_arg': CONSTANTS.DEPOT_KIT_DISTANCE},
    'fr': {'vehicle_depot_fr': CONSTANTS.DEPOT_KIT_DISTANCE},
    'fsa': {'vehicle_depot_fsa': CONSTANTS.DEPOT_KIT_DISTANCE},
    'nl': {'vehicle_depot_nl': CONSTANTS.DEPOT_KIT_DISTANCE},
    'ww2ger': {'vehicle_depot_ww2ger': CONSTANTS.DEPOT_KIT_DISTANCE_WW2},
    'ww2ger41': {'vehicle_depot_ww2ger': CONSTANTS.DEPOT_KIT_DISTANCE_WW2},
    'ww2usa': {'vehicle_depot_ww2usa': CONSTANTS.DEPOT_KIT_DISTANCE_WW2},
    'ww2rus': {'vehicle_depot_ww2rus': CONSTANTS.DEPOT_KIT_DISTANCE_WW2},
    'ww2rusearly': {'vehicle_depot_ww2rus': CONSTANTS.DEPOT_KIT_DISTANCE_WW2},
}
#
#
...
C['COMMANDPOST_TEMPLATES'] = {
    ...
    'chinsurgent': ['deployable_commandpost_chins', 'mil_acv_technical', 'mil_acv_brdm2'],
    'chinsurgent90': ['deployable_commandpost_chins', 'mil_acv_technical', 'mil_acv_brdm2'],
    'chechen90': ['deployable_commandpost_chins', 'mil_acv_technical', 'mil_acv_brdm2'],
    ...
    'fr': ['deployable_commandpost_fr', 'fr_acv_vab'],
    'nl': ['deployable_commandpost_nl', 'nl_acv_boxer'],
    'ww2ger': ['ger_acv_tent'],
    'ww2ger41': ['ger_acv_tent'],
    'ww2usa': ['us_acv_tent'],
    'ww2rus': ['ru_acv_tent'],
    'ww2rusearly': ['ru_acv_tent'],
}
#
#
...
C['VEHICLE_SUPPLY_DEPOT_TEMPLATES'] = {
    ...
    'chinsurgent90': ['vehicle_depot_mil'],
    'chechen90': ['vehicle_depot_mil'],
    ...
    'ww2ger41': ['vehicle_depot_ww2ger'],
    'ww2usa': ['vehicle_depot_ww2usa'],
    'ww2rus': ['vehicle_depot_ww2rus'],
    'ww2rusearly': ['vehicle_depot_ww2rus'],
}
#
#
...
C['OUTPOST_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_firebase'],
    'chechen90': ['deployable_firebase'],
    ...
    'ww2ger41': ['deployable_firebase'],
    'ww2usa': ['deployable_firebase'],
    'ww2rus': ['deployable_firebase'],
    'ww2rusearly': ['deployable_firebase'],
}
# Hideout ammo regen
...
C['OUTPOST_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_firebase_dummy'],
    'chechen90': ['deployable_firebase_dummy'],
    ...
    'ww2ger41': ['deployable_firebase_dummy'],
    'ww2usa': ['deployable_firebase_dummy'],
    'ww2rus': ['deployable_firebase_dummy'],
    'ww2rusearly': ['deployable_firebase_dummy'],
}
#
#
...
C['SUPPLIES_TEMPLATES'] = {
    ...
    'chinsurgent90': [['pr_supply_crate_mil', 1], ['light_supply_crate_mil', 0.5]],
    'chechen90': [['pr_supply_crate_mil', 1], ['light_supply_crate_mil', 0.5]],
    ...
    'ww2ger41': [['pr_supply_crate_ww2ger', 1], ['light_supply_crate_ww2ger', 0.5]],
    'ww2usa': [['pr_supply_crate_ww2usa', 1], ['light_supply_crate_ww2usa', 0.5]],
    'ww2rus': [['pr_supply_crate_ww2rus', 1], ['light_supply_crate_ww2rus', 0.5]],
    'ww2rusearly': [['pr_supply_crate_ww2rus', 1], ['light_supply_crate_ww2rus', 0.5]],
}
#
#
...
C['SUPPLIES_TEMPLATES_TEAMLOCKED'] = {
    ...
    'chinsurgent90': ['pr_supply_crate_mil', 'pr_supply_depot_mil', 'light_supply_crate_mil', 'fixed_supply_crate_mil'],
    'chechen90': ['pr_supply_crate_mil', 'pr_supply_depot_mil', 'light_supply_crate_mil', 'fixed_supply_crate_mil'],
    ...
    'ww2ger41': ['pr_supply_crate_ww2ger', 'pr_supply_depot_ww2ger', 'light_supply_crate_ww2ger', 'fixed_supply_crate_ww2ger'],
    'ww2usa': ['pr_supply_crate_ww2usa', 'pr_supply_depot_ww2usa', 'light_supply_crate_ww2usa', 'fixed_supply_crate_ww2usa'],
    'ww2rus': ['pr_supply_crate_ww2rus', 'pr_supply_depot_ww2rus', 'light_supply_crate_ww2rus', 'fixed_supply_crate_ww2rus'],
    'ww2rusearly': ['pr_supply_crate_ww2rus', 'pr_supply_depot_ww2rus', 'light_supply_crate_ww2rus', 'fixed_supply_crate_ww2rus'],
}
#
#
# ANTI-AIR SETTINGS
...
C['ANTIAIR_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_dshk'],
    'chechen90': ['deployable_dshk'],
...
C['ANTIAIR_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_dshk_dummy'],
    'chechen90': ['deployable_dshk_dummy'],
...
C['HMG_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_50cal_tripod_dshk'],
    'chechen90': ['deployable_50cal_tripod_dshk'],
    ...
    'ww2ger41': ['deployable_mg42'],
    'ww2usa': ['deployable_m1919a6'],
    'ww2rus': ['deployable_m1910'],
    'ww2rusearly': ['deployable_m1910'],
}
#
#
...
C['HMG_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_50cal_tripod_dshk_dummy'],
    'chechen90': ['deployable_50cal_tripod_dshk_dummy'],
    ...
    'ww2ger41': ['deployable_mg42_dummy'],
    'ww2usa': ['deployable_m1919a6_dummy'],
    'ww2rus': ['deployable_m1910_dummy'],
    'ww2rusearly': ['deployable_m1910_dummy'],
}
#
#
# TOW SETTINGS
...
C['TOW_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_spg9'],
    'chechen90': ['deployable_spg9'],
...
C['TOW_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_spg9_dummy'],
    'chechen90': ['deployable_spg9_dummy'],
...
C['MORTAR_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_mortar_2b141_podnos'],
    'chechen90': ['deployable_mortar_2b141_podnos'],
...
C['MORTAR_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_mortar_m252_dummy'],
    'chechen90': ['deployable_mortar_m252_dummy'],
...
C['FOXHOLE_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_foxhole'],
    'chechen90': ['deployable_foxhole'],
    ...
    'ww2ger41': ['deployable_foxhole'],
    'ww2usa': ['deployable_foxhole'],
    'ww2rus': ['deployable_foxhole'],
    'ww2rusearly': ['deployable_foxhole'],
}
#
#
...
C['FOXHOLE_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_foxhole_dummy'],
    'chechen90': ['deployable_foxhole_dummy'],
    ...
    'ww2ger41': ['deployable_foxhole_dummy'],
    'ww2usa': ['deployable_foxhole_dummy'],
    'ww2rus': ['deployable_foxhole_dummy'],
    'ww2rusearly': ['deployable_foxhole_dummy'],
}
#
#
# RAZORWIRE SETTINGS
...
C['RAZORWIRES_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_razorwire'],
    'chechen90': ['deployable_razorwire'],
    ...
    'ww2ger41': ['deployable_razorwire'],
    'ww2usa': ['deployable_razorwire'],
    'ww2rus': ['deployable_razorwire'],
    'ww2rusearly': ['deployable_razorwire'],
}
#
#
# The razorwire templates for each team
...
C['RAZORWIRES_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_razorwire_dummy'],
    'chechen90': ['deployable_razorwire_dummy'],
    ...
    'ww2ger41': ['deployable_razorwire_dummy'],
    'ww2usa': ['deployable_razorwire_dummy'],
    'ww2rus': ['deployable_razorwire_dummy'],
    'ww2rusearly': ['deployable_razorwire_dummy'],
}
#
#
...
C['SANDBAGS_TEMPLATES'] = {
    ...
    'chinsurgent90': ['deployable_sandbags_5m'],
    'chechen90': ['deployable_sandbags_5m'],
    ...
    'ww2ger41': ['deployable_sandbags_5m'],
    'ww2usa': ['deployable_sandbags_5m'],
    'ww2rus': ['deployable_sandbags_5m'],
    'ww2rusearly': ['deployable_sandbags_5m'],
}
#
#
...
C['SANDBAGS_TEMPLATES_DUMMY'] = {
    ...
    'chinsurgent90': ['deployable_sandbags_5m_dummy'],
    'chechen90': ['deployable_sandbags_5m_dummy'],
    ...
    'ww2ger41': ['deployable_sandbags_5m_dummy'],
    'ww2usa': ['deployable_sandbags_5m_dummy'],
    'ww2rus': ['deployable_sandbags_5m_dummy'],
    'ww2rusearly': ['deployable_sandbags_5m_dummy'],
}
#
#
...
C['EXPLOSION_LAGCOMP_DISABLE'] = [
    # Ground to Air
    "stinger_missile", "sa7_missile", "sa3_missile", "sa19_grison", "ru_aa_9M333", "igla_9k38", "gbaa_blowpipe",
    "seacat_missile",
    # Air to air
    ...
    # Mines
    "at_mine_projectile", "at_mine_tm35_projectile", "rumin_mon50_Projectile", "rumin_tm35_Projectile",
    "rumin_pomz_Projectile", "usmin_m1a1_projectile", "usmin_m2a3_projectile", "vnhgr_betty_Projectile",
    "argmin_fmk1_projectile", "argmin_fmk3_projectile", "insgr_hgr_trap_projectile", "insrg_watercontainer_ied_projectile",
    "tm62m_mine_projectile"
]
#
#
